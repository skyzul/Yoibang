...
stiker = await sticker(false, "https://telegra.ph/file/dfee29786ff4c524443c2.png", "ZUL×BOT", "Ngetag lagi saya benet")
...
stiker = await sticker(false, "https://telegra.ph/file/c9f9af78f667c3e5210ac.png", "OWNER ZUL BOT", "Jangan tag kalau ga mau di benet")
	await conn.sendMessage(m.chat, stiker, MessageType.sticker, { sendEphemeral: true, quoted: m })
	}
